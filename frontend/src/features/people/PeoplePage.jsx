...
import { getJson, getBlob, del } from "../../api/client.js";
...
function StatCard({ label, value, color }) {
  return (
    <div className="panel" style={{ margin: 0, textAlign: "center", minWidth: 120 }}>
      <div style={{ fontSize: 13, color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 8 }}>{label}</div>
      <div style={{ fontSize: 35, fontWeight: 700, color: color || "var(--fg)" }}>{value}</div>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
        <span style={{ fontSize: 16, fontWeight: 600 }}>Enrolled People</span>
