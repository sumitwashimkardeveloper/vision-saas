...
export function IconChevron({ size = 12, direction = "right" }) {
  const rotate = { right: 0, down: 90, left: 180, up: 270 }[direction] || 0;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" style={{ transform: `rotate(${rotate}deg)` }}>
