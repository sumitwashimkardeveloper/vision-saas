...
// Mirrors the backend checks in apps/api/routers/auth.py for instant feedback.
// The server re-validates, so this is convenience only — not the source of truth.
    ...
    <div className="login">
      <form className="panel" onSubmit={submit}>
        ...
        <input
          ...
          placeholder="Organization name (e.g. Acme HQ)"
          autoFocus
        />
        <input
          value={tenantId}
